            ...
            <div className="flex flex-col w-[90%]">
              <div className="flex flex-col gap-2">    
                ...
                {message?.intermediateSteps && message.intermediateSteps.length > 0 && (
                  <CollapsiblePanel title="思考过程" defaultOpen={false}>
                    <div className="overflow-x-auto intermediate-steps-container">
                ...
                {/* 最终回答内容 */}
                <div className="overflow-x-auto final-answer-container">
                  {message?.intermediateSteps && message.intermediateSteps.length > 0 && (
                    <div className="final-answer-header">最终回答</div>
                  )}
                  <MemoizedReactMarkdown
                    className="prose dark:prose-invert flex-1 w-full flex-grow max-w-full whitespace-normal"
                    rehypePlugins={[rehypeRaw] as any}
